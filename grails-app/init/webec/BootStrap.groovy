...
class BootStrap {
    def init = { servletContext ->
        ...
        def mall      = new Lecturer(lastname:'Mall', firstname:'Daniel', email:'daniel.mall@fhnw.ch').save()
        ...
        def mpeter     = new User(username: 'marco.peter1@students.fhnw.ch', password: 'mpeter1', lastname:'Peter', firstname:'Marco').save()
        ...
        def eti   = new Module(name:'eti', semester:3, location:'5.4.H06', lecturer:mall, user:mwinter).save()
        ...
        new Exam(date:Date.parse("yyyy-MM-dd hh:mm:ss", "2018-11-23 08:15:00"), description:'Kurztest 2', grade: 3.57, module:eti).save()
